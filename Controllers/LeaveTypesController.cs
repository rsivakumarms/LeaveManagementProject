...
namespace LeaveManagementProject.Controllers
{
    public class LeaveTypesController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var leaveTypes = _imapper.Map<List<LeaveTypeVM>>(await _context.LeaveTypes.ToListAsync());
            return View(leaveTypes);
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var leaveTypeVM = _imapper.Map<LeaveTypeVM>(leaveType);
        ...
        public async Task<IActionResult> Create( LeaveTypeVM leaveTypeVM)
        {
            ...
            {
                var leaveType = _imapper.Map<LeaveType>(leaveTypeVM);
